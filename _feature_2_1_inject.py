#!/usr/bin/env python3
"""Feature 2.1: Inject change_summary into audit_data"""
import os
main_file = '/home/yusupha/my_tools/nexus_audit/nexus_audit/main.py'
with open(main_file, 'r', encoding='utf-8') as f:
    code = f.read()
print("\n=== FEATURE 2.1: Inject change_summary ===")
# Find the spot before report generation
old_pattern = """    print()
    # ── Generate reports ──────────────────────────────────────────────────"""
new_pattern = """    print()
...
if old_pattern in code:
    ...
    print("SKIP: Could not find report generation section")

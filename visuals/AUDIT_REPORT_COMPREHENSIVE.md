...
Total CVEs found: **697** | Outdated packages: **42**
...
| `Django` | 5.2.12 | 6.0.5 | ⚠️ Outdated | 300 |
...
```json
{
  ...
  "why_harmful": "This direct import creates a tight coupling where `nexus_social` and `nexus_tournaments` are directly dependent on
...
---
*Report generated by Nexus Audit Command Center — 2026-05-24 11:33:53*